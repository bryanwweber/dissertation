...
\begin{figure}
    ...
    \ffigbox{%
        \begin{subfloatrow}[3]
            \ffigbox[\FBwidth]
                {\includegraphics[height=5.335cm]{05-MCH/mch-pressure-1}}
                {\caption{Mix \#1}\label{fig:mch-pressure-1}}
            \ffigbox[\FBwidth]
                {\includegraphics[height=5.335cm]{05-MCH/mch-pressure-2}}
                {\caption{Mix \#2}\label{fig:mch-pressure-2}}
            \ffigbox[\FBwidth]
                {\includegraphics[height=5.335cm]{05-MCH/mch-pressure-3}}
...
of \textcite{Mittal2009}, three mixtures of MCH/\ce{O2}/\ce{N2}/\allowbreak Ar at equivalence
