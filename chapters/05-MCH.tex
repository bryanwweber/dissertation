...
branched cycloalkanes. MCH has the elemental composition \ce{C7H14}, and
...
Three different mixtures of MCH/\ce{O2}/\ce{N2}/Ar are prepared in this study, as
...
and the mole fraction of \ce{O2} is varied to adjust the equivalence ratio. This
experimental design allows these data to be used to validate chemical kinetic
models for changes in \ce{O2} concentration, which is an important variable in
...
relative proportions of \ce{O2}, \ce{N2}, and Ar are adjusted so that the same specific
...
\begin{enumerate}
    \item The base \ce{C1}--\ce{C4} chemistry has been updated with the AramcoMech
...
experiment. The abscissa is normalized time, where 1 is the
first stage ignition and 2 is the overall ignition. The time until the
...
\begin{figure}
\includegraphics[width=11cm]{05-MCH/mch-sample}
...
Normalized times of 1 and 2 represent the first-stage and overall ignition
delays respectively.}
...
\begin{figure}
\includegraphics[width=11cm]{05-MCH/mch-tic}
...
(lines) is shown in \cref{fig:mch-model-1-over,fig:mch-model-2-over,,%Comma necessary to avoid compression
...
\begin{figure}
    \floatsetup[subfigure]{captionskip=5pt}
    \ffigbox{%
        \begin{subfloatrow}
            \ffigbox
                {\includegraphics[width=6.9cm]{05-MCH/mch-model-1-first}}
                {\caption{First stage ignition delays}\label{fig:mch-model-1-first}}
            \ffigbox
                {\includegraphics[width=6.9cm]{05-MCH/mch-model-1-over}}
...
% \begin{figure}
    \ffigbox{%
        \begin{subfloatrow}
            \ffigbox
                {\includegraphics[width=6.9cm]{05-MCH/mch-model-2-first}}
                {\caption{First stage ignition delay}\label{fig:mch-model-2-first}}
            \ffigbox
                {\includegraphics[width=6.9cm]{05-MCH/mch-model-2-over}}
...
% \begin{figure}
    \ffigbox{%
        \begin{subfloatrow}
            \ffigbox
                {\includegraphics[width=6.9cm]{05-MCH/mch-model-3-first}}
                {\caption{First stage ignition delay}\label{fig:mch-model-3-first}}
            \ffigbox
                {\includegraphics[width=6.9cm]{05-MCH/mch-model-3-over}}
...
considered the autoignition of stoichiometric mixtures of MCH with \ce{O2}/\ce{N2}
    ...
    \begin{floatrow}
        \ffigbox
            ...
            {\caption{Comparison of the present model with the experiments from
                ...
                and for stoichiometric mixtures in \ce{O2}/\ce{N2} air.}
...
\Cref{fig:mch-sim-pres-comp} shows the pressure traces of the experiments
...
\begin{figure}
\includegraphics[width=11cm]{05-MCH/mch-sim-pres-comp}
...
\Cref{fig:mch-mole-fracs,fig:mchene-mole-fracs} show the mole fractions
...
\Cref{fig:mch-mole-fracs} shows that the model predicts no significant
...
its consumption by \ce{O2} at \SI{900}{\kelvin}. Furthermore, the increasing importance of the
...
important while the direct \ce{HO2} elimination reaction becomes more important.
...
MCH+\ce{HO2}=R+\ce{H2O2}; \ce{H2O2}(+M)=2OH(+M) becomes important and drives
...
importance of the \ce{HO2} elimination channel (due to nuances in the various
...
approach is justified because many of the reactions of the \ce{C0}--\ce{C4} base
mechanism are important to the ignition process (e.g.,
\ce{H2O2}(+M)=2OH(+M)), but we are more interested in the effect of updates to
...
The role of the ROO=methylcyclohexene+\ce{HO2} reactions in the left column of
...
cychexch2 and mchr2 radicals. For example, the mchr2 radical adds to \ce{O2} and
...
\textcite{Weber2014}. QOOH subsequently adds to \ce{O2} and leads to chain branching.
...
formation of ROOH by reaction with \ce{HO2} followed by consumption of ROOH
is a chain propagation path through the reactions ROO+\ce{HO2}=ROOH+\ce{O2};
ROOH=RO+OH. In this sequence two radicals are formed (RO, OH) and two
radicals are consumed (ROO, \ce{HO2}). Thus, the formation of ROOH by
reaction with \ce{HO2} and its subsequent destruction has a somewhat
...
agreement at lower temperature. In particular, the MCH+\ce{HO2} rate constants
...
and theoretical calculations are needed for the fuel+\ce{HO2} reaction class to
...
of \textcite{Mittal2009}, three mixtures of MCH/\ce{O2}/\ce{N2}/Ar at equivalence
...
MCH primarily decomposes by H-abstraction reactions involving OH and \ce{HO2}
...
elimination of methylcyclohexene and \ce{HO2} becomes competitive with the
isomerization reaction, leading to the NTC region of the overall ignition
delay. Finally, at high temperatures, MCH+\ce{HO2} reactions dominate and form \ce{H2O2} to end
the NTC region.
...
pathways is required and more accurate rate constants for fuel+\ce{HO2}
