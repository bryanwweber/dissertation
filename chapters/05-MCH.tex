...
\begin{figure}
    \ffigbox{%
        \begin{subfloatrow}
            \ffigbox
                {\includegraphics[width=7.9cm]{05-MCH/mch-model-1-first}}
                {\caption{First stage ignition delays}\label{fig:mch-model-1-first}}
            \ffigbox
                {\includegraphics[width=7.9cm]{05-MCH/mch-model-1-over}}
...
\begin{figure}
    \ffigbox{%
        \begin{subfloatrow}
            \ffigbox
                {\includegraphics[width=7.9cm]{05-MCH/mch-model-2-first}}
                {\caption{First stage ignition delay}\label{fig:mch-model-2-first}}
            \ffigbox
                {\includegraphics[width=7.9cm]{05-MCH/mch-model-2-over}}
...
\begin{figure}
    \ffigbox{%
        \begin{subfloatrow}
            \ffigbox
                {\includegraphics[width=7.9cm]{05-MCH/mch-model-3-first}}
                {\caption{First stage ignition delay}\label{fig:mch-model-3-first}}
            \ffigbox
                {\includegraphics[width=7.9cm]{05-MCH/mch-model-3-over}}
