...
$\tau_2 = \tau_{\text{overall}} - \tau_1$. Case 5 has ignition delays of
...
Cases 1 and 2 were normalized by the first-stage ignition delay of Case
5, $\tau_{1,5}=\SI{10.96}{\milli\second}$. Case 3 was punctured just at
the first-stage ignition delay and was therefore normalized by its
first-stage ignition delay, $\tau_{1,3}=\SI{11.05}{\milli\second}$. Case
4 was normalized by its first-stage ignition delay
$\tau_{1,4}=\SI{9.09}{\milli\second}$ until the first-stage ignition;
after first-stage ignition, Case 4 was normalized by
$\tau_{2,4}=\tau_{\text{overall},5}-\tau_{1,4}=\SI{16.41}{\milli\second}$.
...
The peaks shown in \cref{tab:mch-tic} had matching coefficients greater
than 80, indicating a good match.
...
presented previously. In addition, calibration curves for the methylcyclohexene
isomers were unavailable. Thus, the calibration curve for MCH was applied
to the peak areas for the methylcyclohexenes.
...
fraction of each species is shown for simplicity. The error bars are shown
as discussed in \cref{sec:rsa-uncertainty}---mole fraction uncertainties of
$\pm\SI{20}{\percent}$ and normalized time uncertainties of $\pm\num{0.1}$.
...
over predicted by approximatlye a factor of 3. In addition, the relative
...
MCH and the methylcyclohexane isomers are quantified. Furthermore, several
