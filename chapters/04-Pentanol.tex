...
and offers several similar advantages as the butanol isomers as compared
...
addition to the new data at $P_C=\SI{40}{\bar}$ presented here.

\begin{enumerate}
\item Ignition delays measured in a shock tube and RCM\cite{Tang2013, Tsujimura2012}
...
\begin{floatrow}
    \ffigbox[7.5cm]
        {}{
            \ffigbox[\FBwidth]
                {\includegraphics[width=7cm]{04-Pentanol/ipeoh-7bar}}
            ...
            \vspace{7pt}
            \ffigbox[\FBwidth]
                {\includegraphics[width=7cm]{04-Pentanol/ipeoh-20bar}}
                {\caption{Shock tube and RCM ignition delay times from
            ...
            \vspace{7pt}
            \ffigbox[\FBwidth]
                {\includegraphics[width=7cm]{04-Pentanol/ipeoh-40bar}}
                {\caption{Shock tube and RCM ignition delay times from
    ...
    \ffigbox[7.5cm]
        {}{
            \ffigbox[\FBwidth]
                {\includegraphics[width=7cm]{04-Pentanol/ipeoh-phi05}}
            ...
            \vspace{7pt}
            \ffigbox[\FBwidth]
                {\includegraphics[width=7cm]{04-Pentanol/ipeoh-phi10}}
                {\caption{Experimental reactive (red), simulated reactive
                (blue), and experimental non-reactive (gray) pressure
            ...
            \vspace{7pt}
            \ffigbox[\FBwidth]
                {\includegraphics[width=7cm]{04-Pentanol/ipeoh-phi20}}
                {\caption{Experimental reactive (red), simulated reactive
                (blue), and experimental non-reactive (gray) pressure
...
measured in the shock tube are generally predicted to within a factor of 1.5. The RCM experiments
...
with the profiles shifted so TDC occurs at \SI{0}{\second}. Interestingly,
...
heat release \SI{25}{\milli\second} after TDC followed by a larger heat
...
Since the reaction 2ho2$\Leftrightarrow$h2o2+o2 is represented by two sets of $A$, $b$,
...
seen in \cref{fig:ipeoh-40sens} as compared to \cref{fig:ipeoh-20sens}.
...
formyl radical and water shows up as somewhat sensitive, especially for
...
\floatsetup{captionskip=-4pt}
    \ffigbox
        {\includegraphics[width=10cm,angle=-90]{04-Pentanol/ipeoh-20sens}}
    ...
    \vspace{7pt}
    \ffigbox
        {\includegraphics[width=10cm,angle=-90]{04-Pentanol/ipeoh-40sens}}
        {\caption{Sensitivity of the ignition delay to changes in
        the reaction rate coefficients for three equivalence ratios.
        Initial conditions for constant-volume adiabatic simulations are
...
up to 20\% fuel consumption. It is seen that fuel is mainly consumed by
...
or decomposed to enol species by the concerted elimination of HO$_2$. Around
...
pathway involving hydrogen transfer from the OH group is shown to be
...
New experimental ignition delay data has been collected in an RCM at
...
delays measured in the RCM and shock tubes fairly well, although
