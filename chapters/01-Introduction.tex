...
In the ideal case, biofuels could be used as drop-in replacements for traditional
fuels, requiring few changes in engine design. However, the combustion properties
of biofuels may be substantially different from the fuels they are intended to
replace. Moreover, finding sustainable large-scale production methods for biofuels
may be challenging. These concerns make it difficult to quickly switch
...
developed. These include advanced engines capable of operating in favorable combustion
regimes such as so-called Low Temperature Combustion (LTC) engines, of which one type is the
Homogeneous Charge Compression Ignition (HCCI) engine. These devices avoid
...
improve emissions characteristics, but do not necessarily improve fuel economy.

Neither of these approaches---new fuels and new engine technologies---is able
to mitigate all of the negative impacts of
...
One important aspect of LTC engines is their control scheme. In traditional
compression-ignition (CI) and spark-ignition (SI) engines, the phasing of
the combustion is controlled by an external process---fuel injection and spark
timing respectively. These control schemes are dictated by the fuel used in
each engine and its state of mixture with the oxidizer upon entry into the
cylinder. By contrast, LTC engines have no external process to control the
combustion phasing, and because they use premixed fuel/air charges, the
combustion phasing is controlled almost entirely by the chemical kinetics
of the fuel and the oxidizer. This makes the use of predictive chemical
models particularly important when designing LTC engines.
...
importance to combustion, one focus of the larger molecule work is naturally
on biofuels. These biofuels typically include chemical species such as
...
Since the focus of this study is on alcohols, these fuels will be highlighted
...
faithfully reproduces the physical and/or chemical properties of the real fuel.
...
\textcite{Bieleveld2009,Naik2005}. Moreover, MCH and other naphthenes make
up a significant fraction of the hydrocarbon content in alternative ``traditional''
fuels, such as fuels derived from shale oil. Recent work on MCH combustion will also
...
the isomers of butanol, the \ce{C4} alcohols, and \iPeOH{}, a \ce{C5}
...
One of the most common biofuels currently in use is ethanol (\ce{C2H5OH}).
...
systems. These include laminar flame speeds \cite{Veloo2011a}, jet-stirred reactor (JSR)
...
Pang2012, Pang2012a, Seal2013, Pang2012b, El-Nahas2012, Zhou2011, Moc2010, Vasu2010}, \ce{HO2}
\cite{Zhou2012, Alecu2012, Black2010a}, and \ce{CH3} \cite{Katsikadakos2013, Katsikadakos2012}.

Several studies of ignition delay of the butanol isomers have been conducted
in both shock tubes (STs) and rapid compression machines (RCMs), including work in STs by \textcite{Moss2008,
...
from \ce{C1}--\ce{C4} (methanol to butanol) at pressures of \SIlist{2;10;12}{\atmosphere} under dilute
...
and temperatures between \SIlist{1250;1800}{\kelvin}. In addition,
...
measured the time-history of the concentration of the fuel, OH, \ce{H2O}, \ce{C2H4}, CO, and \ce{CH4}
...
mechanism of \nBuOH{} by performing experiments over the pressure and temperature ranges of
\SIrange{61}{92}{\bar} and \SIrange{795}{1200}{\kelvin}, respectively.
\textcite{Vranckx2011} also updated
...
temperatures between \SIlist{716;1121}{\kelvin}, at pressures near
\SIlist{20;40}{\atmosphere}, and and at equivalence ratios of
...
\nBuOH{} for low- to intermediate\hyp{}temperature conditions between
\SIlist{675;925}{\kelvin}, at pressures of
\SIlist{15;30}{\bar}, and at equivalence ratios of $\phi =$ \numlist{0.5;1.0;2.0}.
...
butanol, covering temperatures between \SIlist{715;910}{\kelvin},
...
\cref{chap:buoh}. In summary, \textcite{Weber2013} found that the rank order of
...
oxidizer and $\phi =$ \numlist{0.5;2.0} where the \ce{O2}:\ce{N2}
...
mole fractions of \ce{CH4}, CO, \ce{C2H4}, \ce{C3H6}, \ce{C2H4O}, \ce{C4H8O},
...
of species concentrations very well, particularly \ce{C2H4}. This result
...
for conditions of temperature between \SIlist{1280;1480}{\kelvin}, pressures
near \SIlist{1.5;3}{\atmosphere}, and equivalence ratios of $\phi =$ \numlist{1.0;0.5}.
...
of MCH/\ce{O2}/\ce{N2}/Ar mixtures at pressures of \SIlist{15.1;25.5}{\bar},
...
collectively considered conditions between \SIlist{795;1560}{\kelvin}
and \SIlist{1;70}{\atmosphere}. Further studies described in \cref{chap:mch}
...
and pressures between \SIlist{15;20}{\atmosphere}. \textcite{Martinengo1965}
...
was similar to that developed by \textcite{Roblee1961} in that it used an
expansion chamber separated from the reaction chamber by a diaphragm
that was punctured by a knife at the appointed time.

Using a gas chromatograph coupled to a mass spectrometer to analyze their
samples, \textcite{Minetti1994} were able to identify approximately \num{25}
...
\textcite{Ribaucour1998, Minetti1999} also noted that the presence of the
...
were noted for the aromatic species with ortho-alkyl groups as compared to alkane species.
These aromatics with alkyl groups in the ortho positions are able to undergo the critical hydrogen-transfer
...
peroxy radicals, during the induction period and also noted that effects
from the ring structure and the double bond combined to produce the
observed chemistry.
...
\textit{i}-octane, and one ternary blend of \textit{i}-octane/1-hexene/\allowbreak toluene.
...
temperature chain branching pathways by reactions with both the alkyl
...
results have been published from this sampling apparatus.
...
meaning that the ignition process is allowed to proceed nearly unhindered.
...
fuels at high\hyp{}pressure, low\hyp{}temperature conditions that have not been
...
\Cref{chap:facilities} presents an
...
that is newly upgraded for this work. Detailed uncertainty analyses
...
the preliminary characterization of an all-new sampling system for the RCM
...
below, submitted to \textit{Combustion and Flame}.
