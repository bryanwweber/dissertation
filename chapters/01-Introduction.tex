...
studied the ignition delays of \textit{n}-butanol for low- to intermediate-%
...
to predict the ignition delays of \textit{n}-butanol, over-predicting
...
behavior during the ignition of \textit{t}-butanol that was not present
during the ignition of the other isomers.

\textcite{Weber2013a} studied the autoignition of \textit{i}-butanol
...
a newly developed kinetic model for \textit{i}-butanol combustion
...
\textit{n}-butanol for several different kinetic mechanisms.

\textcite{Karwat2011} studied the ignition delays of \textit{n}-butanol
...
during the induction period of \textit{n}-butanol ignition. They quantified
mole fractions of CH$_4$, CO, C$_2$H$_4$, C$_3$H$_6$, C$_2$H$_4$O, C$_4$H$_8$O,
1-C$_4$H$_8$, and \textit{n}-butanol at several times during the ignition.
