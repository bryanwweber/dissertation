...
of the RSA described in the work of \textcite{Mittal2007, Mittal2006}.
...
the radial cross section of the rod when the sampling tank is under
...
The sampled gases flow from the sample tank into an evacuated sampling
bottle, as shown schematically in \cref{fig:rcm-schematic}. The sample
is diluted with ultra-high-purity helium (\SI{99.999}{\percent} purity)
and taken to the analysis system, which is described in \cref{sec:gcms}.
...
gases are warmed to room temperature in the sample bottle. The fuel
partial pressure in the sampling bottle is a factor of two lower than
the saturated vapor pressure at room temperature, so that heating of the
sample bottle is not required.
