...
Name & Value\\
\midrule
Column Flow Rate & \SI{0.98}{\milli\liter\per\minute}\\
Purge Flow Rate & \SI{3.0}{\milli\liter\per\minute}\\
Linear Velocity & \SI{19.7}{\centi\meter\per\second}\\
Split Ratio & 100 : 1\\
\midrule
Column Temperature & \SI{50}{\degreeCelsius}\\
...
\midrule
Ionization Voltage & \linebreakcell{\SI{0.73}{\kilo\volt} for \SI{8}{\minute};\\\SI{0.83}{\kilo\volt} for \SI{27}{\minute}}\\
...
Shimadzu model QP-2010S, equipped with a split/splitless injector, as mentioned previously. The column
used is a Restek RTX-1PONA capillary column
with length \SI{100}{\meter}, inner diameter \SI{0.25}{\milli\meter}, and film
thickness of \SI{0.5}{\micro\meter}. The carrier gas is helium with \SI{99.9999}{\percent} purity. The operating parameters of the GC/MS
...
Each peak integrated by averaging the mass spectra
