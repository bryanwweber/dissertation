...
to be lower than the EOC pressure by a factor of \num{6.25}. The actual driving
...
by substituting components (e.g.\ substituting Ar for \ce{N2} results in
...
\SI{0.01}{\gram} prior to injection through a septum. Proportions of \ce{O2}, \ce{N2}, and
...
Each unique $P_C$ and $T_C$ condition is repeated at least \num{5} times to
...
\ce{O2} in the oxidizer with \ce{N2}, so that the specific heat ratio
...
different specific heat ratio between \ce{O2} and \ce{N2} in the non-reactive experiment compared
...
\ce{O2}, \ce{N2} and Ar (i.e.\ no more than \SI{7}{\percent} of any mixture is the
fuel), and since the specific heats of \ce{O2}, \ce{N2} and Ar are only weakly
...
%
\begin{align}
U_{T_0} = \sqrt{\left(B_{T_0}\right)^2 + \left(R_{T_0}\right)^2} = \sqrt{\left(\SI{3}{\kelvin}\right)^2 + \left(\SI{0.05}{\kelvin}\right)^2} = \SI{3}{\kelvin}
\end{align}
...
\SI{3.38}{\mole\percent} \tBuOH{}, \SI{20.30}{\mole\percent} \ce{O2}, and
\SI{76.32}{\mole\percent} \ce{N2}, i.e.\ a $\phi=1.0$ mixture of \tBuOH{}
...
\SI{42000}{\pascal} of \ce{O2} and \SI{160650}{\pascal} of \ce{N2}. The partial
...
The following analysis is conducted for a mixture of
\SI{1.05}{\mole\percent} MCH, \SI{10.99}{\mole\percent} \ce{O2},
\SI{12.83}{\mole\percent} \ce{N2}, and \SI{75.13}{\mole\percent} Ar, i.e.
...
\SI{33500}{\pascal} of \ce{O2}, \SI{78200}{\pascal} of \ce{N2}, and
...
to hold the puncture rod in the retracted position against the force of a
...
\Cref{fig:rsa-pressure} shows pressure traces from the reaction chamber with the RSA installed.
...
used in this work, the maximum EOC pressure is approximately \SI{15}{\bar}; to allow
