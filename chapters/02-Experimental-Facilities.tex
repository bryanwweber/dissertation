...
Shimadzu model QP-2010S, equipped with a 10-port Valco sample injection valve and split
...
A schematic of the sample injection valve is shown in \autoref{fig:gcms-valve}.
...
The pressure in the sample loop is monitored by an MMA type pressure
transducer, the same model as used in \autoref{sec:unc-p0}. The
...
Species are identified from the TIC by an automated library
search.
\end{document}
