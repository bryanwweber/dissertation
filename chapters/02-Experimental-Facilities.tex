...
depending on $T_C$. After expansion, the gases are allowed to warm to room
...
for a given sampling time is excellent, indicating the reproducibility
of this method. Moreover, \textcite{He2007} used a similar procedure in their sampling experiments
of isooctane, and compared results using a heated syringe and an
...
boundary layer along the reactor walls. When the diaphragm is ruptured,
...
The uncertainty of the sampling time is related to how quickly the pressure
...
uncertainty in the sampling time is estimated as $\pm\SI{1}{\milli\second}$.
