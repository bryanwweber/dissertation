...
\autoref{fig:gcms-quad}) and the detector is placed parallel to the $x-y$ plane
in \autoref{fig:gcms-quad} at the other end of the rods(not shown in
\autoref{fig:gcms-quad}). A positive DC voltage is applied
