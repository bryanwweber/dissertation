...
\setmathfont[range={"2212,"002B,"003D,"0028,"0029,"005B,"005D,"221A,"2211,"2248,"222B,"007C,"2026,"2202,"00D7,"0302}]{Cambria Math}
...
$\hat{C}_p$ fits causes approximately $\mathcal{O}(\SI{1}{\kelvin})$ changes in $T_C$.
...
\end{equation}
%
The uncertainty of the pressures $P_i$ and $P$ are equal and can be estimated by
...
\addlinespace
$x_i$, $y_i$ & $\overline{X} + \beta_i$, $\overline{Y}+b\beta_i$ \\
\addlinespace
