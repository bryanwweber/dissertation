...
contents by GC/MS, GC-FID, and GC-TCD. These studies have verified the
...
\begin{figure}
    ...
    \begin{minipage}{0.3\textwidth}
        \includegraphics[width=6cm]{03-Butanol/tbuoh-05press}
    ...
    \quad
    \begin{minipage}{0.3\textwidth}
        \includegraphics[width=6cm]{03-Butanol/tbuoh-10press}
    ...
    \quad
    \begin{minipage}{0.3\textwidth}
        \includegraphics[width=6cm]{03-Butanol/tbuoh-20press}
