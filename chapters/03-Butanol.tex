...
\begin{figure}[!ht]
    \ffigbox{%
        \begin{subfloatrow}[4]
            ...
            \ffigbox
                {\includegraphics[height=2cm]{03-Butanol/tbuoh-skeletal}}%
...
\Autoref{tab:buoh-heats} shows a comparison of the higher heating value of
...
\Autoref{fig:tbuoh-phi10} shows the pressure traces for \tBuOH{}
...
\begin{figure}
    ...
    \caption{Reactions causing the most heat release in the ignition of the
        butanol isomers. The reaction number refers to \autoref{fig:buoh-heat}.}
