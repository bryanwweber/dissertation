...
% In their mechanism, \textcite{Sarathy2012}
% included a semi-detailed peroxy chemistry model, while in the MIT model, a detailed peroxy chemistry model was included, using
% rates computed from the work of \textcite{Welz2013} for ethanol.
...
% \iBuOH{} \cite{Hansen2013,Merchant2013}.
...
tends to under-predict the experimental ignition delays of \iBuOH{},
whereas the MIT mechanism tends to over-predict the experimental data.
One of the reasons for this is demonstrated by the path flux diagram
shown in \cref{fig:ibuoh-mitpath}. The diagram is produced by the same
procedure as \crefrange{fig:buoh-npath}{fig:buoh-ipath},
except the initial conditions of the simulation considered in
\cref{fig:ibuoh-mitpath} are \SI{800}{\kelvin} and \SI{30}{\bar} for a
stoichiometric mixture of \iBuOH{} with air. The percentages in plain
text are the results from a simulation with the MIT mechanism
\cite{Weber2013a}; the percentages in italics are from a simulation with
the Sarathy et al.\ mechanism \cite{Sarathy2012}.

\begin{figure}
    \includegraphics[width=13cm]{03-Butanol/ibuoh-mitpath}
...
the mechanisms as to the amount of formation of each of the primary fuel
radicals. The reactions of the primary fuel radicals are also similar
between the mechanisms, although the formation of $\alpha$-hydroxybutylperoxy
occurs nearly twice as much in the Sarathy et al.\ mechanism as in the
MIT mechanism.

In the third level of reactions, large differences between the mechanisms
can be noted from \cref{fig:ibuoh-mitpath}. In the pathway of the 
$\beta$-hydroxybutyl radical, it can be seen that the breakdown of the
$\beta$-hydroxybutylperoxy radical occurs partially via the Waddington
mechanism to form acetone, formaldehyde and hydroxyl (OH) in the
Sarathy et al.\ mechanism, whereas this pathway is not active in the
MIT mechanism, although it is included in the model.
...
model. In the MIT mechanism, nearly all of the 
$\alpha$-hydroxybutylperoxy goes to form isobutyraldehyde, which is 
itself the primary product of reactions of $\alpha$-hydroxybutyl. This 
means that over \SI{99}{\percent} of the $\alpha$-hydroxybutyl radical
is directed into the formation of isobutyraldehyde and hydroperoxyl (HO$_2$).
