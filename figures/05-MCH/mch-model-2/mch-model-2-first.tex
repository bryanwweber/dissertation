...
\addplot[only marks,blue,mark=square] table[x index={1},y index={2}] {mix-2-15-bar-expt.txt};
\addplot[only marks,red,mark=o] table[x index={1},y index={2}] {mix-2-25-bar-expt.txt};
\addplot[only marks,darkgreen,mark=triangle] table[x index={0},y index={3}] {phi-05-50-bar.txt};
\addplot[no markers,blue,smooth] table[x index={1}, y index={3}] {mix-2-15-bar.txt};
\addplot[no markers,red,smooth] table[x index={1}, y index={3}] {mix-2-25-bar.txt};
\addplot[no markers,darkgreen,smooth] table[x index={0}, y index={6}] {phi-05-50-bar.txt};
