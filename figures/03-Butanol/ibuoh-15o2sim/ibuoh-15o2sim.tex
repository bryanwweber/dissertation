...
\addplot table[y={create col/linear regression={y=VPRO}}] {phi20-15sim.txt};
\addplot table[y=Tig, y error=Error] {phi10-15bar.txt};
\addplot table[y={create col/linear regression={y=VPRO}}] {phi10-15sim.txt};
\addplot table[y=Tig, y error=Error] {phi05-15bar.txt};
\addplot table[y={create col/linear regression={y=VPRO}}] {phi05-15sim.txt};
...
\legend{{[darkgreen]$\phi=2.0$, Experiment},{[darkgreen]$\phi=2.0$, Simulation},{[red]$\phi=1.0$, Experiment},{[red]$\phi=1.0$, Simulation},{[blue]$\phi=2.0$, Experiment},{[blue]$\phi=2.0$, Simulation}}
\end{semilogyaxis}
