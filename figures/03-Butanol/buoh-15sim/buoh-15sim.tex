...
\node[align=left,text width=3.6cm] at (axis description cs:0.75,0.9) {Symbols: Experiments Solid Lines: Simulations};
\end{semilogyaxis}
...
\begin{semilogyaxis}[
    ...
    title={\large Butanol/O$_2$/N$_2$, $\phi=1.0$, $P_C=\SI{15}{\bar}$},
    xmin=1.13, xmax=1.40,
    ymin=8, ymax=200,
    axis y line=none,
    axis x line*=top,
