...
\addplot table[y={create col/linear regression={y=MITnew}}] {\thibar};
\addplot table[y={create col/linear regression={y=MITold}}] {\thibar};
\legend{{\SI{15}{\bar}},{\SI{30}{\bar}},,,Experiments,,,,,,{MIT New},{MIT Old}};
\end{semilogyaxis}
...
\node[anchor=west] at (axis cs:1.15,250) {O$_2$ : N$_2$ = 1 : 3.76};
\end{semilogyaxis}
\end{tikzpicture}
\end{document}
