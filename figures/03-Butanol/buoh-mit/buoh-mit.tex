...
\addplot table[y=Sarathy] {\fifbar};
\addplot table[y=MIT] {\fifbar};
\addplot table[y=Sarathy] {\thibar};
\addplot table[y=MIT] {\thibar};
\addplot table[y={create col/linear regression={y=Sarathy}}] {\fifbar};
\addplot+[restrict x to domain=1.16:1.22] table[y={create col/linear regression={y=MIT}}] {\fifbar};
\addplot table[y={create col/linear regression={y=Sarathy}}] {\thibar};
\addplot+[restrict x to domain=1.16:1.30] table[y={create col/linear regression={y=MIT}}] {\thibar};
\legend{{\SI{15}{\bar}},{\SI{30}{\bar}},,,{[blue] Experiments},,,,,,{[gray] Sarathy et al.\ Model},{[red] Hansen et al.\ Model}};
\end{semilogyaxis}
