...
\draw[Stealth-] +(180:0.85in) -- ++(180:3) node[text width = 1.25cm] at +(180:0.25) {Carrier Gas In};
...
\draw[decorate, decoration={coil,amplitude=4pt,segment length=3pt}]
    (-4.5,-1.5) -- (-4.5,0.5) node[midway,xshift=-10pt,rotate=90] {Sample Loop};
...
\draw[-Stealth] +(108:0.85in) -- ++(108:3) node[rotate=108, text width = 1.25cm] at +(108:0.25) {Sample Out};
